...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('garbage_savings_datas', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('trash_bank_id')->index('garbage_savings_datas_trash_bank_id_foreign')->after('trash_category_id')->nullable();
    ...
    {
        Schema::table('garbage_savings_datas', function (Blueprint $table) {
            $table->dropForeign('garbage_savings_datas_trash_bank_id_foreign');
